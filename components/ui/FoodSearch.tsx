                            ...
                            <ul className="py-1 bg-base-100">
                                {filteredFoods.map((food: MenuItem) => (
                                    ...
                                    <li
                                        ...
                                        role="option"
                                    >
                                        {/* <div className="text-sm font-medium  break-words flex-1  flex-shrink-100 whitespace-wrap ">{food.name}</div> */}

                                        <p className="text-sm font-medium  break-words flex-1  flex-shrink-50">
                                            {food.name.length > 17 ? (
